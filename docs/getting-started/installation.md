...
The server runs as a Docker Compose stack (API, web UI, PostgreSQL, DuckDB, Redis, worker, load balancer). Prometheus and Grafana are optional deployment overlays.
