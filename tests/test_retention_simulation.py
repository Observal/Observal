...
async def test_error_isolation():
    ...
    # spans failed (returns 0), session_events succeeded (returns 1)
    # _purge_time_based catches exceptions and also checks _delete_batch return
    # The key point: session_events was still called despite spans failure
