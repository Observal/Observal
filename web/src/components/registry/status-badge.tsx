...
const statusConfig: Record<string, { bg: string; text: string }> = {
  ...
  open: { bg: "bg-light-blue", text: "text-dark-blue" },
  done: { bg: "bg-light-green", text: "text-dark-green" },
  dismissed: { bg: "bg-muted", text: "text-muted-foreground" },
  unread: { bg: "bg-light-blue", text: "text-dark-blue" },
  "action required": { bg: "bg-light-yellow", text: "text-dark-yellow" },
  ready: { bg: "bg-light-green", text: "text-dark-green" },
  blocked: { bg: "bg-light-red", text: "text-dark-red" },
