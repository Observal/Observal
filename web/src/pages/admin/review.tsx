...
function DetailHead({
  ...
  return (
    <div className="flex items-start gap-[11px] border-b border-border p-5">
      ...
      <StatusBadge status={status} variant="dot" className="ml-auto shrink-0" />
    </div>
  );
}
      ...
      >
        {dense ? (
          <span className="flex items-center gap-2.5">
            ...
            <StatusBadge status={readiness(item)} variant="dot" className="shrink-0" />
          </span>
        ) : (
          <>
            {/* .review-panel-top */}
            <span className="flex items-center justify-between gap-2.5">
              ...
              <StatusBadge status={readiness(item)} variant="dot" />
            </span>
                    ...
                    >
                      {view === "list" ? (
                        <span className="flex items-center gap-2.5">
                          ...
                          <StatusBadge status="pending" variant="dot" className="shrink-0" />
                        </span>
                      ) : (
                        <>
                          <span className="flex items-center justify-between gap-2.5">
