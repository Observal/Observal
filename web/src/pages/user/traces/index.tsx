...
function TraceStatus({ row }: { row: Session }) {
	return (
		<StatusBadge
			status={row.is_active ? "live" : "completed"}
			variant="dot"
		/>
	);
}
...
export default function TracesPage() {
	...
	const saveThisView = useCallback(() => {
		...
		write
			.then(() => toast.success("Link to this view copied"))
			.catch(() => toast.error("Could not copy the link to this view"));
